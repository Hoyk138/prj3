...
<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
  ...
  <li class="nav-item">
    <a class="nav-link" id="pills-popular-tab" data-toggle="pill" href="#pills-popular" role="tab" aria-controls="pills-popular" aria-selected="false">인기순</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="pills-new-tab" data-toggle="pill" href="#pills-new" role="tab" aria-controls="pills-new" aria-selected="false">최신순</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="pills-rating-tab" data-toggle="pill" href="#pills-rating" role="tab" aria-controls="pills-rating" aria-selected="false">평점순</a>
  </li>
</ul>
...
<!-- 도서 조회 리스트 시작  -->
	<c:forEach var="book" items="${ratingRangeList}"><!-- newRangeBook -->
		<div id="bookList" class="row">
		 	 <div id="bookImg"><a href="book_detail.do?code=${book.book_code}"> <!-- 북코드 넘겨주기 --> 
		 	 	<img src="http://localhost:8080/team1_user_prj3/common/images/images_book/${book.img}" style="width: 130px; height: 190px;"/></a>
		 	 </div>  
		 	 <div id="bookContent" class="col-8" >
