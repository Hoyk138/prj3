...
<nav id="navbar-example3" class="navbar navbar-light bg-light" style="border:1px solid #f0f0f0">
  ...
  <nav class="nav nav-pills flex-column">
    <a class="nav-link"><img src="http://211.63.89.133/team1_user_prj3/common/images/images_mypage/my_book.png">&nbsp;책</a>
    <nav class="nav nav-pills flex-column">
        <a class="nav-link ml-3 my-1" href="pay_book.do?id=<%=id%>">내 서재</a>
    <!--   <a class="nav-link ml-3 my-1" href="recommend.do">추천 도서</a> -->
    </nav>
    <a class="nav-link"><img src="http://211.63.89.133/team1_user_prj3/common/images/images_mypage/my_pay.png">&nbsp;결제</a>
    <nav class="nav nav-pills flex-column">
      <a class="nav-link ml-3 my-1" href="pay_history.do?id=${user_id}">결제 내역</a>
      <a class="nav-link ml-3 my-1" href="charge_cash.do">충전 관리</a>
    </nav>
    <a class="nav-link"><img src="http://211.63.89.133/team1_user_prj3/common/images/images_mypage/my_user.png">&nbsp;개인</a>
    <nav class="nav nav-pills flex-column">
